...
class HCSR04:
    ...
    def _send_pulse_and_wait(self):
        ...
        We use the method `machine.time_pulse_us()` to get the
        microseconds until the echo is received.
        """
    ...
    def distance_mm(self):
        """
        Get the distance in milimeters without floating point
        operations.
        """
        ...
        # pulse_time // 2 // 2.91 -> pulse_time //
        # 5.82 -> pulse_time * 100 // 582
