...
class VentanaPrincipal(Ui_MainWindow):
    def setupVentana(self):
        ...
        self.motor1_slide.sliderReleased.connect(self.cambio_slide_m1)
        self.motor2_slide.sliderReleased.connect(self.cambio_slide_m2)
        self.motor3_slide.sliderReleased.connect(self.cambio_slide_m3)
        self.motor4_slide.sliderReleased.connect(self.cambio_slide_m4)
        self.motores_slide.sliderReleased.connect(self.cambio_slide_motores)
        self.consola_text = ''
